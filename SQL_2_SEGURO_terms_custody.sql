-- ============================================================================
-- SQL 2 - terms_custody_chain (SEGURO - NÃO SOBRESCREVE)
-- ============================================================================
...
-- Políticas terms_versions (só se não existirem)
DO $$ BEGIN
...
-- Políticas terms_acceptances (só se não existirem)
DO $$ BEGIN
...
-- INSERIR VERSÃO INICIAL DOS TERMOS (só se não existir)
