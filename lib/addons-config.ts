...
export const ADDONS: Addon[] = [
  ...
  },
  {
    ...
    description: 'Relatório detalhado com análise de todos os seus registros, padrões identificados e recomendações personalizadas.',
  ...
  // -------------------------------------------------------------------------
  {
    id: 'kit-seguranca',
    name: 'Kit Segurança',
    description: 'Pacote completo para situações de risco. Inclui guia de plano de fuga, checklist de documentos e contatos de emergência personalizados.',
